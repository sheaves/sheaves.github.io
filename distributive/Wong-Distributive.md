...
<img src="http://sheaves.github.io/distributive/dist_def.png" alt="Definition of distributive law" width="60" align="middle"/>

satisfying the following equalities:

<img src="http://sheaves.github.io/distributive/dist_axioms.png" alt="Axioms for a distributive law" width="300" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/comp_mult.png" alt="Multiplication for the composite monad" width="100" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/comp_assoc.png" alt="Associativity for the composite monad" width="300" align="middle"/>

Not only is $TS$ a monad, we also have monad maps $T \eta^S: T \Rightarrow TS$ and $\eta^T S: S \Rightarrow TS$:

<img src="http://sheaves.github.io/distributive/comp_maps.png" alt="Monad maps to the composite monad" width="300" align="middle"/>

Asserting that $T \eta^S$ is a monad morphism is the same as asserting these two equalities:

<img src="http://sheaves.github.io/distributive/comp_maps_check.png" alt="Check that we have a monad map" width="200" align="middle"/>

Similar diagrams hold for $\eta^T S$. Finally, the multiplication $m$ also satisfies a *middle unitary law*:

<img src="http://sheaves.github.io/distributive/comp_middle_unit.png" alt="Middle unitary law" width="200" align="middle"/>

To get back the distributive law, we can simply plug the appropriate units at both ends of $m$:

<img src="http://sheaves.github.io/distributive/comp_inverse.png" alt="Recovering the distributive law" width="70" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/lift_univ.png" alt="Universal property of S-algebras" width="250" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/lift_diagrams.png" alt="Commutative diagrams for lifts" width="300" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/lift_action.png" alt="S-action on TU^S" width="120" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/lift_dist.png" alt="Getting a distributive law from a lift" width="120" align="middle"/>

The key steps in the proof that these constructions are mutually inverse are contained in the following two equalities:

<img src="http://sheaves.github.io/distributive/lift_inverse.png" alt="Constructions are mutually inverse" width="300" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/alg_actions.png" alt="Actions of T, S and TS" width="270" align="middle"/>

Further, $\sigma$ is *distributes over* $\tau$ in the following sense:

<img src="http://sheaves.github.io/distributive/alg_dist.png" alt="S-action distributes over T-action" width="240" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/alg_lifts.png" alt="Diagram of required lifts" width="250" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/alg_TS.png" alt="Lifts for Phi" width="240" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/adj_square.png" alt="Distributive adjoint situation" width="220" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/adj_string.png" alt="Distributive adjoints in string" width="300" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/adj_cross.png" alt="Distributive adjoints again" width="300" align="middle"/>
...
<img src="http://sheaves.github.io/distributive/adj_e.png" alt="Getting e from u or f" width="300" align="middle"/>
...
> <img src="http://sheaves.github.io/distributive/yang_baxter.png" alt="Yang-Baxter condition" width="240" align="middle"/>
